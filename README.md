# Lectura de Base de Datos MySQL y Generación de Archivo Excel (.xlsx)

Aprende a leer los datos de una tabla de una base de datos MySQL usando Python y la librería 'PyMySQL' y poder generar un archivo Excel (.xlsx) usando la librería 'openpyxl', conoce cómo exportar datos desde una base de datos MySQL hacia un archivo Excel, con Python.
